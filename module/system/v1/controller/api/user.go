...
import (
	...
	auth "github.com/gophab/gophrame/module/authority/v1/service"
...
type UserController struct {
	...
	AuthorityService  *auth.AuthorityService     `inject:"authorityService_v1"`
...
func init() {
	inject.InjectValue("userController_v1", userController)
}
