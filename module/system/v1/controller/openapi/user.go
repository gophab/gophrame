...
import (
	...
	"github.com/gophab/gophrame/module/system/v1/service/dto"
	"github.com/gophab/gophrame/module/system/v1/service/mapper"
...
type UserOpenController struct {
	...
	InviteCodeService  *service.InviteCodeService    `inject:"inviteCodeService_v1"`
	UserMapper         *mapper.UserMapper            `inject:"userMapper_v1"`
	SocialUserMapper   *mapper.SocialUserMapper      `inject:"socialUserMapper_v1"`
	SmsCodeValidator   *SmsCode.SmsCodeValidator     `inject:"smsCodeValidator_v1"`
...
type AdminUserOpenController struct {
	controller.ResourceController
	UserService       *service.UserService       `inject:"userService_v1"`
	TenantService     *service.TenantService     `inject:"tenantService_v1"`
	SocialUserService *service.SocialUserService `inject:"socialUserService_v1"`
	InviteCodeService *service.InviteCodeService `inject:"inviteCodeService_v1"`
	UserMapper        *mapper.UserMapper         `inject:"userMapper_v1"`
	SocialUserMapper  *mapper.SocialUserMapper   `inject:"socialUserMapper_v1"`
...
func init() {
	inject.InjectValue("userOpenController_v1", userOpenController)
	inject.InjectValue("adminUserOpenController_v1", adminUserOpenController)
}
