...
func init() {
	inject.InjectValue("organizationOpenController_v1", organizationOpenController)
	inject.InjectValue("adminOrganizationOpenController_v1", adminOrganizationOpenController)
}

type OrganizationOpenController struct {
	controller.ResourceController
	OrganizationService *service.OrganizationService `inject:"organizationService_v1"`
}
