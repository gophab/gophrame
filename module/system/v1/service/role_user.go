...
type RoleUserService struct {
	service.BaseService
	RoleUserRepository *repository.RoleUserRepository `inject:"roleUserRepository_v1"`
	RoleRepository     *repository.RoleRepository     `inject:"roleRepository_v1"`
	UserService        *UserService                   `inject:"userService_v1"`
}

var roleUserService *RoleUserService = &RoleUserService{}

func init() {
	inject.InjectValue("roleUserService_v1", roleUserService)
