...
type OrganizationUserService struct {
	service.BaseService
	OrganizationUserRepository *repository.OrganizationUserRepository `inject:"organizationUserRepository_v1"`
...
func init() {
	inject.InjectValue("organizationUserService_v1", organizationUserService)
}
