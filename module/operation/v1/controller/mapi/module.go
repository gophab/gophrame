...
import (
	...
	"github.com/gophab/gophrame/module/operation/v1/service"
...
type ModuleMController struct {
	...
	ModuleService *service.ModuleService `inject:"moduleService_v1"`
}

var moduleMController *ModuleMController = &ModuleMController{}

func init() {
	inject.InjectValue("moduleMController_v1", moduleMController)
}
