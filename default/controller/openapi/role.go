...
var roleOpenController *RoleOpenController = &RoleOpenController{}

func init() {
	inject.InjectValue("roleOpenController", roleOpenController)
}
...
func (r *RoleOpenController) EditRole(c *gin.Context) {
	...
	err = r.RoleService.LoadPolicy(data.Id)
	if err != nil {
		response.SystemErrorCode(c, errors.ERROR_UPDATE_FAIL)
		return
	}
